...
def process_handles(messages_db: MessagesDatabase, handle_matcher: HandleMatcher, handles: List[Tuple[int, str]]) -> Dict[str, int]:
    """
...
def main():
    ...
    success_rate = (process_stats['new_users_created'] + process_stats['existing_users_matched']) / process_stats['total_handles'] * 100
