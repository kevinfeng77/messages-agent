...
class TestChatsTable(unittest.TestCase):
    ...
    def test_user_ids_serialization(self):
        """Test that user_ids are properly serialized as comma-separated strings"""
        chat_id = "500"
        ...
        with sqlite3.connect(self.db_path) as conn:
            ...
            # Should be pipe-separated string
            self.assertEqual(raw_users, "user_a|user_b|user_c")
...
class TestChatMigrationIntegration(unittest.TestCase):
    ...
    def _create_source_database(self):
        ...
        with sqlite3.connect(self.source_db_path) as conn:
            ...
            # Insert test data
            # Chat 1: Quantabes
            cursor.execute("INSERT INTO chat VALUES (1, 'Quantabes', '+12345678901', 'iMessage')")
            cursor.execute("INSERT INTO handle VALUES (101, '+12345678901', 'iMessage')")
            cursor.execute("INSERT INTO handle VALUES (102, '+12345678902', 'iMessage')")
            cursor.execute("INSERT INTO chat_handle_join VALUES (1, 101)")
            cursor.execute("INSERT INTO chat_handle_join VALUES (1, 102)")
            
            # Chat 2: Test Group
            cursor.execute("INSERT INTO chat VALUES (2, 'Test Group', 'chat123', 'iMessage')")
            cursor.execute("INSERT INTO handle VALUES (103, '+12345678903', 'iMessage')")
